...
import { COWORK_SCOPED_REVIEW } from './version.mjs';
...
export function readiness(store) {
  ...
  return {
    ...
    items: [
      ...
      item('broad_production_review_gate', 'pending', 'Fresh broad production/partner-ready Cowork review required for this v0.5.x tranche'),
