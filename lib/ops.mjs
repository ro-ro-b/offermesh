...
export function readiness(store) {
  ...
  return {
    ...
    items: [
      ...
      item('broad_production_review_gate', broadReview.passed ? 'done' : 'pending', broadReview.passed ? `External Claude Cowork returned ${broadReview.score}/10 for ${broadReview.claim_scope}` : 'Fresh broad production/partner-ready Cowork review required for this v0.6.0 tranche'),
