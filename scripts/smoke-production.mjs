...
try {
  ...
  assert('status is v0.8.0 Revolv', status.body.version === '0.8.0' && status.body.product === 'revolv' && status.body.engine === 'offermesh', status.body);
  ...
  assert('source bundle versioned', bundle.body.service_version === '0.8.0' && bundle.body.bundle_hash?.startsWith('0x'), bundle.body);
} catch (err) {
  failures++;
